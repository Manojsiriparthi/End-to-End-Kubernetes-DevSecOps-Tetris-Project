...
# ==============================================================================
# Description: Test environment EKS infrastructure (copied from working dev)
# Environment: Test
...
module "networking" {
  ...
  # Test-specific configuration (production-like)
  ...
  enable_flow_logs         = true   # Enable for testing
